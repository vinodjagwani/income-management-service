...
import au.seisma.income.exception.dto.ErrorCodeEnum;
import au.seisma.income.exception.dto.ErrorResponse;
...
public class DefaultExceptionHandler {
    ...
    public Mono<ResponseEntity<Object>> handleException(final ValidationException ex) {
        ...
        if (throwable instanceof BusinessServiceException businessServiceException) {
            return Mono.just(new ResponseEntity<>(getErrorResponse(businessServiceException.getErrorEnum().toString(), errorInfos), ((BusinessServiceException) throwable).getHttpStatus()));
        }
